...
import EBSChat from "./components/EBSChat";
  ...
  return (
    <html lang="en" className={`${heading.variable} ${body.variable}`}>
      <body style={{ fontFamily: "var(--font-body)" }}>
        ...
        <header className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur border-b border-white/10">
          <div className="relative max-w-6xl mx-auto px-6 h-16 flex items-center justify-center">
            ...
            <nav className="absolute right-6 hidden md:flex gap-8 text-sm">
              <a href="#services" className="text-white/90 hover:text-[#e1a730] transition">Services</a>
              <a href="#location" className="text-white/90 hover:text-[#e1a730] transition">Location</a>
            </nav>
          </div>
        </header>
        ...
        {/* Zempotis AI Chatbot — branded for EBS Barbers */}
        <EBSChat clientId="ebs-barbers" />
